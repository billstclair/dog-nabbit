...
module DogNabbit.EncodeDecode exposing
    ( archivedGameDecoder
    , decodeSavedModel
    , defaultOneMove
    , encodeArchivedGame
...
import DogNabbit.Board as Board exposing (rc)
...
import DogNabbit.WhichServer as WhichServer
import ElmChat
...
encodeNamedGame game =
    JE.object
        ...
        , ( "otherPlayerids", JE.list JE.string game.otherPlayerids )
...
namedGameDecoder proxyServer =
    JD.succeed NamedGame
        ...
        |> required "otherPlayerids" (JD.list JD.string)
        |> required "player" playerDecoder
